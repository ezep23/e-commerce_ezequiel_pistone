...
login.innerHTML = `<ul class="navbar-nav session">${ 
    localStorage.getItem("email") 
        ? `<li> ¡Hola, ${name}!</li><span> | </span><li><img height="25" src="../img/cart.png" alt="Comprar" /><b>${localStorage.getItem("quantity")} </b></li><span> | </span><li onclick="logout()">Cerrar sesión</li>`   
